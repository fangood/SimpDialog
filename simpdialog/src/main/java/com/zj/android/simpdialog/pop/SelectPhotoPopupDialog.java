package com.zj.android.simpdialog.pop;
 ...
 */
public class SelectPhotoPopupDialog extends PopupWindow {
    ...
    public SelectPhotoPopupDialog(Context context) {
        super(context, null);
    }
     ...
     */
    public SelectPhotoPopupDialog(Activity mAty, LayoutInflater mLayoutInflater, BottomPopClickListener bottomPopClickListener) {
        this(mAty);
        this.mAty = mAty;
