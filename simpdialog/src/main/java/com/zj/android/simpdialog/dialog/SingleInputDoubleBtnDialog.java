...
import com.zj.android.simpdialog.listener.DialogInputDoubleBtnOnClickListener;


/**
 * 前面字数限定，弹窗---用途完善用户名
 */
public class SingleInputDoubleBtnDialog extends BaseDialog {

    public static class Builder extends DoubleBtnDialog.Builder {

        protected EditText et_dg_input_content;
        protected TextView tv_dg_input_end;

        protected DialogInputDoubleBtnOnClickListener baseDialogInputDoubleBtnClickListener;

        public Builder setBaseDialogInputDoubleBtnClickListener(DialogInputDoubleBtnOnClickListener baseDialogInputDoubleBtnClickListener) {
        ...
        @Override
        public Builder setBaseDialogDoubleBtnClickListener(DialogDoubleBtnClickListener baseDialogDoubleBtnClickListener) {
