...
public class DoubleBtnDialog extends BaseDialog {
    ...
    public static class Builder extends BaseDialog.Builder {
        ...
        //回调
        protected DialogDoubleBtnClickListener baseDialogDoubleBtnClickListener;
        ...
        void initBtn(FrameLayout fl_dg_bottom, final Dialog dialog) {
            ...
            final TextView tv_dg_double_left = view
                    .findViewById(R.id.tv_dg_double_left);
            final TextView tv_dg_double_right = view
            ...
            tv_dg_double_left.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (baseDialogDoubleBtnClickListener != null) {
                        baseDialogDoubleBtnClickListener.baseOnLeftClickListener(tag);
                    }
                }
            });
            ...
            tv_dg_double_right.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    dialog.dismiss();
                    if (baseDialogDoubleBtnClickListener != null) {
                        baseDialogDoubleBtnClickListener.baseOnRightClickListener(tag);
                    }
                }
            });
