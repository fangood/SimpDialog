 ...
 * 底部两个按钮，中间一行可以输入文字
 */
public class InputDoubleBtnDialog extends BaseDialog {

    private static final int MAX_LENGTH = 100;

    public static class Builder extends SingleInputDoubleBtnDialog.Builder {
        ...
        void initContent(View dialogView) {
            ...
            ll_dg_base_input = dialogView.findViewById(R.id.ll_dg_base_input);
